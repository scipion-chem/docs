...
.. _rosetta-DARC_Docking:

###############################################################
Rosetta DARC Docking
###############################################################
This protocol follows the `DARC <https://pubmed.ncbi.nlm.nih.gov/26181386/>`_ docking procedure.
It can take as input either an AtomStruct (where you would need to define the residue(s) where the docking will be performed around) or a SetOfStructROIs (to directly define the region as a Structural Regions Of Interest).
...
.. image:: ../../../../_static/images/plugins/rosetta/rosetta_form2.png
   :alt: rosetta form2
