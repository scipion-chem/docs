...
- **A) :ref:`General`**: It includes protocols for managing the objects or files generated by Scipion.
- **B) :ref: `Databases`**: It includes protocols related to the main databases for protein sequences, structures or small molecules.
