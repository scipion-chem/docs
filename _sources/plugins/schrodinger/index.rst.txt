...
- :ref:`schrodinger-fix-structure`: Allows the user to use `Prime <https://www.schrodinger.com/products/prime>`_ for fixing an atomic structure. 
- :ref:`schrodinger-split-structure`: Allows the user to use the *split_structure.py* script from Schrodinger mmShare. 
