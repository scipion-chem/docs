...
.. figure:: docs-chem/scipion-chem.gif
   :alt: scipion logo
...
the related plugins. These plugins integrate mainly software for Virtual Drug Screening. You can find the complete list
in https://github.com/scipion-chem
...
Scipion-chem documentation
--------------------------
Scipion-chem's documentation is built using `Sphinx <http://www.sphinx-doc.org>`_ and hosted on
...
of our docs on the `docs GitHub repository <https://github.com/scipion-chem/docs>`_ .
